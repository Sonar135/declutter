...
$query= mysqli_query($conn, "UPDATE items set donation_status='approved' where id='$id'");
...
function sendThankYouEmail($toEmail, $item) { // Add username parameter
    try {
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Donation Acceptance';
        ...
        <body>
            <div class="container">
                ...
                <p>Your donated item  <span> ' . htmlspecialchars($item) . '</span> has been approved</p>
            </div>
            <div class="footer">
